...
Equal(true, OpenHandCarryAnchorSolver.TryPlace(0, true, 949, 48, 1000, 1612, 32, 16, out int l1), "L1 places");
Equal(917, l1, "L1 clears the indicator cell");
Equal(true, OpenHandCarryAnchorSolver.TryPlace(1, true, 949, 48, 1000, 1612, 32, 16, out int l2), "L2 places");
Equal(869, l2, "L2 continues the 48-pixel pitch leftward");
Equal(true, OpenHandCarryAnchorSolver.TryPlace(2, true, 949, 48, 1000, 1612, 32, 16, out int l3), "L3 places");
...
Equal(true, OpenHandCarryAnchorSolver.TryPlace(0, false, 949, 48, 1000, 1612, 32, 16, out int r1), "R1 places");
Equal(1644, r1, "R1 sits right of the real row edge");
Equal(true, OpenHandCarryAnchorSolver.TryPlace(1, false, 949, 48, 1000, 1612, 32, 16, out int r2), "R2 places");
Equal(1692, r2, "R2 continues the pitch rightward");

// CarryOn anchor solver: a right-anchored cell pushes the R anchors past it.
Equal(true, OpenHandCarryAnchorSolver.TryPlace(0, false, 1700, 48, 1000, 1612, 32, 16, out int r1Shifted), "shifted R1 places");
...
Equal(true, OpenHandCarryAnchorSolver.TryPlace(0, true, 1040, 48, 1000, 1612, 32, 16, out int l1Inside), "inside-bar cell places");
...
Equal(true, OpenHandCarryAnchorSolver.TryPlace(0, true, 949 + 27, 48, 1000 + 27, 1612 + 27, 32, 16, out int l1Shifted), "shifted geometry places");
...
Equal(false, OpenHandCarryAnchorSolver.TryPlace(-1, true, 949, 48, 1000, 1612, 32, 16, out _), "negative index");
Equal(false, OpenHandCarryAnchorSolver.TryPlace(0, true, 949, 0, 1000, 1612, 32, 16, out _), "empty cell");
Equal(false, OpenHandCarryAnchorSolver.TryPlace(0, true, 949, 48, 1612, 1612, 32, 16, out _), "empty row");
Equal(false, OpenHandCarryAnchorSolver.TryPlace(0, true, 949, 48, 1000, 1612, 0, 16, out _), "empty icon");
